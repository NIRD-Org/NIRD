...
const LCVAForm = ({ update = false }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (update) {
        await API.put(`/api/v1/lcva/${id}`, formDataToSend, {
  ...
  return (
    <div className="p-2 md:p-6">
      <AdminHeader>
        {update
          ? "Edit Low/No Cost Voluntary Activities"
          : "Low/No Cost Voluntary Activities Entry Form"}
      </AdminHeader>
      <form
