  ...
  const getAllKpiApprovals = async () => {
    try {
      const response = await API.get(
        `/api/v1/kpi-approvals/get-kpiapprovals?decision=0&theme=${theme_id}&gp=${gram_id}`
      );
    ...
    <div>
      <div className="p-6">
        ...
        <div className="flex justify-center mt-10">
          <Link
            to={`/admin/add-gp-wise-kpi?state_id=${state_id}&dist_id=${dist_id}&block_id=${block_id}&gram_id=${gram_id}&theme_id=${theme_id}`}
          >
