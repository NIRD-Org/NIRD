...
const YFPoa2Form = ({ update }) => {
    ...
    return (
      <div style={{ fontSize: "14px", maxWidth: "100%", margin: "0 auto" }}>
        <AdminHeader>
          Second Weekly Plan Of Action - Month : {selectedMonth.name} {currentYear}
        </AdminHeader>
        ...
        <Button onClick={handleSubmit} className="primary-button mb-10 float-right mt-4">
        Submit
      </Button>
