...
const Poa1AdminData = () => {
  ...
  const handleApprovalSubmit = async () => {
    // 1) Check if there's valid POA data
    ...
    try {
      // 3) Build the payload based on the selected POA type
      const payload =
        poaType === "poa1"
          ? {
      ...
      // 7) Reset isSubmitting to false after successful submission
      ...
      {((poaType === "poa1" && poa1Approval.status !== "1") ||
        ...
        <div className="mt-4 flex flex-col sm:flex-row items-start sm:items-center gap-2">
          ...
          <div className="flex flex-col sm:mx-2">
            ...
            <input
              // No more "required" or onInvalid here because not in a real form
              type="text"
