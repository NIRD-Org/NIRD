...
const POA4Form = ({ update }) => {
  ...
  const lastDayOfMonth = new Date(currentYear, selectedMonth + 1, 0).getDate(); // Get the last day of the month
  ...
  Array.from({ length: lastDayOfMonth - 22 }, (_, i) => i + 23);
  ...
  return (
    <div style={{ fontSize: "14px", maxWidth: "100%", margin: "0 auto" }}>
      <AdminHeader>
        Fourth Weekly Plan Of Action - Month : {months[selectedMonth].name}{" "}
        {currentYear}
      </AdminHeader>
      <div
        style={{
