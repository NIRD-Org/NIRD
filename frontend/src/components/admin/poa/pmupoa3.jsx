...
const POA3Form = ({ update }) => {
  ...
  const getDaysInMonth = () =>
    Array.from({ length: lastDayOfWeek }, (_, i) => i + 15);
  ...
  return (
    <div style={{ fontSize: "14px", maxWidth: "100%", margin: "0 auto" }}>
      <AdminHeader>
        Third Weekly Plan Of Action - Month : {months[selectedMonth].name}{" "}
        {currentYear}
      </AdminHeader>
      <div
        style={{
