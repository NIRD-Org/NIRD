...
const DeletedItems = () => {
  ...
  const configurations = {
    state: {
      ...
      endpoint: "/api/v1/state/all?status=0",
    ...
    dist: {
      ...
      endpoint: "/api/v1/dist/all?status=0",
    ...
    block: {
      ...
      endpoint: "/api/v1/block/all?status=0",
    ...
    theme: {
      ...
      endpoint: "/api/v1/theme/all?status=0",
    ...
    kpi: {
      ...
      endpoint: "/api/v1/kpi/all?status=0",
    ...
    user: {
      ...
      endpoint: "/api/v1/users/all?status=0",
