...
function ThemeForm({ update }) {
  ...
  const fields = [{ name: "theme_name", label: "Theme Name", type: "textarea", required: true }];

  return (
    <div className="container mx-auto p-6">
      <form onSubmit={handleSubmit}>
        <div className="py-4">
          <AdminHeader>{!update ? "Add Theme" : "Update Theme"}</AdminHeader>
