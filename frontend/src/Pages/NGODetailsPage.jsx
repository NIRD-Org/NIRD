...
function NGODetailsPage() {
  const data = [
      ...
      { deployment: "Bihar", name: "Angita Kumari", block: "Nagar", gPs: "Rasalpur, Korma", ngo: "CENTRE DIRECT ( Child Friendly Village)", year: "N/A", remarks: "N/A" },
      ...
      { deployment: "Chhattisgarh", name: "Savitri Sahu", block: "Narayanpur", gPs: "Bade amhari, Belgaon, Bakulwahi, Borand, Halamimujmeta, Nawmunjmeta, Pharasgaon", ngo: "Piramal Foundation, TRiF ( Healthy village and child friendly village)", year: "TRiF - Oct23, Piramal- Sep24", remarks: "N/A" },
      ...
      { deployment: "Goa", name: "MUHAMED AJAMAL M", block: "Dharbhandora", gPs: "Dharbhandora, Mollem, Collem", ngo: "Green Goa Foundation( Forest and Wild life Protection)", year: "1986", remarks: "N/A" },
      ...
      { deployment: "Gujarat", name: "Varma Virendrakumar Dineshbhai", block: "Vadodara (City & Rural)", gPs: "Nandesari, Padamala, Karachiya", ngo: "Deepak Foundation(Healthy village)", year: "N/A", remarks: "N/A" },
      ...
      { deployment: "Himachal Pradesh", name: "Tushar Sharma", block: "Dharamshala", gPs: "Sokni Da-Kot, Dhagwar, Pantehar Passu, Bagli", ngo: "Waste Warrior(Clean and Green Village)", year: "2022", remarks: "Its operating in GP Sokni Da-Kot since 2022." },
  ...
  { deployment: "Jharkhand", name: "PRIYANKA", block: "Meral", gPs: "Meral Purab, Meral Pashim, Aragi", ngo: "Piramal Foundation 9healthy Village)", year: "2023"},
  ...
  { deployment: "Jharkhand", name: "MANGAL KUMAR SINGH", block: "Jamtara", gPs: "Dulhadiha, Bewa, Udalbani", ngo: "Badlao Foundation (Socially Secure Village)", year: "N/A", remarks: "Working in Udalbani Panchayat" },
  { deployment: "Karnataka", name: "Maloth Mohanlal", block: "Raichur", gPs: "Gunjahalli GP, Yeragera GP", ngo: "Water Aid, Swami Vivekanand NGO (Clean and Green Village)", year: "1. August-2024, 2. 2019", remarks: "1. WaterAid is working to improve access to clean water, decent toilets, and awareness about ODF (Open Defecation Free villages) and good hygiene for rural communities. It has been active in the Gunjhalli GP project since August 2024. 2. Swami Vivekananda NGO is working on improving access to clean water and good hygiene for school children and rural communities. It has been active in both project GPs, Yeragera and Gunjhalli, since 2019." },
  { deployment: "Karnataka", name: "Gugulothu Saikumar", block: "Gurumitkal", gPs: "Chandraki GP, Putpak GP", ngo: "Tata Kalike Trust, Shri Kshetra Dharmasthala Rural Development Project ( Water Sufficient Vilage - safe drinking water, and New libraries For Infrastructure development)", year: "1. 2010, 2. 2015", remarks: "N/A" },
  ...
  { deployment: "Kerala", name: "Neena Krishnan B R", block: "SULTAN BATHERY", gPs: "Meenangadi", ngo: "THANAL( healthy Village, clean & Green village ..1. Carbon Neutral Awareness Campaigns 2. ABHA ID card creation camps )", year: "2016", remarks: "" },
  ...
  { deployment: "Madhya Pradesh", name: "Krishna Madhhasiya", block: "Petlawad", gPs: "Gangakhedi, Mathmath, Ghughri, Karwad, Mandan, Gunawad", ngo: "TRIF, Vagdhara ( Good governance)", year: "TRIF - 2018, Vagdhara -2024", remarks: "N/A" },
  ...
  { deployment: "Madhya Pradesh", name: "AMAN KOUSHIK", block: "Balaghat", gPs: "Kosami, Bagadara, Gongalai, Neveganv, Chichaganv, Naitara", ngo: "PRADAN (GPDP Preparation & Capacity Building)", year: "N/A", remarks: "N/A" },
  ...
  { deployment: "Madhya Pradesh", name: "DHARMENDRA SINGH THAKUR", block: "Tendukheda (ABP)", gPs: "Tejgarh, Sailwadamal, Samdai, Sanga, Bagdari, Tendukheda", ngo: "Piramal Foundation (Healthy Village)", year: "N/A", remarks: "N/A" },
  { deployment: "Madhya Pradesh", name: "Vikrant Lowanshi", block: "Rajpur", gPs: "Julvania, Panva, Nihali, Thakli, Rui", ngo: "Aga Khan Foundation, TRIF Foundation, Piramal Foundation (Organic Farming , Soil testing , GPDP Preparation, Anti drugs Awareness )", year: "N/A", remarks: "Piramal Foundation is working in many villages of my block on PRIs but they don't have any initiative in my Cluster GPs yet." },
  { deployment: "Maharashtra", name: "Nikhil Harishchandra Gore", block: "Desaiganj", gPs: "Tulashi, Kondhala, Kurud, Kinhala, Shivrajpur", ngo: "SEARCH ( Anti- Alchohol Awareness ), Piramal Foundation (Education), Srushti Foundation(Community Forest Development)", year: "SEARCH(2010), PIRAMAL Foundation(2022), Srushti(2023)", remarks: "N/A" },
  ...
  { deployment: "Maharashtra", name: "KUMATKAR PRITAM RAMDAS", block: "Shirur", gPs: "Pabal, Kendur, Dhamari", ngo: "Vigyan Ashram ( Technology Awareness), Maher Ashram( Orphanage)", year: "1983, 2002", remarks: "N/A" },
  ...
  { deployment: "Manipur", name: "Themshingphi Konghay", block: "Sawombung CD Block", gPs: "Waiton, Khundrakpam, Haraorou Tangkham, Sawombung", ngo: "Moringa for life ( Healthy Village) ", year: "1998", remarks: "N/A" },
  ...
  { deployment: "Odisha", name: "Mallekedi Sharath Chandra Prasad", block: "Phulbani Block", gPs: "Keredi, Minia, Bisipada", ngo: "PRADAN NGO ( Agriculture in tribal areas)", year: "2022", remarks: "Working for improving agriculture especially in tribal areas. It is active since 2022." },
  { deployment: "Odisha", name: "SHREETAM KALTA", block: "Nuapada Block", gPs: "Ansena, Saipala, Darlimunda", ngo: "N/A", year: "N/A", remarks: "N/A" },
  { deployment: "Odisha", name: "SANJIBANI MAJHI", block: "Keonjhar", gPs: "Sirispal, Dimbo, Padmapur", ngo: "TATA Steel Trust ( Man power for Village Support)", year: "2024", remarks: "N/A" },
  ...
  { deployment: "Telangana", name: "THALLOORI PAVAN KUMAR", block: "Lecja", gPs: "Medikonda, Pullikal, Kesavapuram, Venisampur", ngo: "Mamidipudi Venkatarangaiya Foundation ( child friendly Village)", year: "1981", remarks: "Aims to eliminate child labor by ensuring all children access quality education" },
...
const sortedData = useMemo(() => {
  ...
  if (sortConfig.key !== null) {
    sortableItems.sort((a, b) => {
      if (a[sortConfig.key] === "N/A" && b[sortConfig.key] !== "N/A") {
        return 1; // Always put "N/A" at the bottom when a is "N/A"
      }
      if (b[sortConfig.key] === "N/A" && a[sortConfig.key] !== "N/A") {
        return -1; // Always put "N/A" at the bottom when b is "N/A"
      }
    ...
    <table style={{ width: '100%', border: '1px solid black' }}>
      <thead>
        <tr style={{ borderBottom: '3px solid black', background: 'aliceblue', fontWeight: 'bold' }}>
          <th onClick={() => requestSort('index')}>Sl.No.</th>
          <th onClick={() => requestSort('deployment')}>State</th>
          <th onClick={() => requestSort('name')}>Name of the Young Fellow (YF)</th>
          <th onClick={() => requestSort('block')}>Block Where the Cluster is Located</th>
          <th onClick={() => requestSort('gPs')}>Names of GPs</th>
          <th onClick={() => requestSort('ngo')}>Name of NGO</th>
          <th onClick={() => requestSort('year')}>Operating since YEAR</th>
        </tr>
      </thead>
      <tbody>
        {sortedData.map((item, index) => (
          <tr key={index}>
            <td style={{ padding: '10px', border: 'solid 1px gray' }}>{index + 1}</td>
