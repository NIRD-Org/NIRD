          ...
          <div className="flex flex-1">
            <div className="flex-1">
              ...
              <p class="mt-4 text-white text-lg md:text-xl">
                Join us in enhancing lives through sustainable development and empowering
                communities across India. Together, we can make a lasting impact.
              </p>
              <a
                href="#learn-more"
                class="mt-6 inline-block bg-blue-600 text-white px-6 py-3 rounded-md text-lg font-medium hover:bg-blue-700"
              >
                Learn More
              </a>
            </div>
            ...
            <img
              className="absolute w-full top-0 right-0 left-0 z-[-10] bg-opacity-30 h-[90%] object-cover"
...
const Themes = () => {
  const images = [
    ...
    {
      imgUrl: "https://res.cloudinary.com/dtbbuevez/image/upload/v1717959547/4_1_tnvg14.jpg",
